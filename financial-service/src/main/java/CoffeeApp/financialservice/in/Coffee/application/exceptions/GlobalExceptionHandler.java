...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleTransactionTypeAlreadyExistsException(TransactionTypeAlreadyExistsException e,
    ...
    @ExceptionHandler(LastSessionIsOpenedException.class)
    public ResponseEntity<ErrorResponseDto> handleLastSessionIsOpenedException(LastSessionIsOpenedException e,
                                                                              WebRequest webRequest) {
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                webRequest.getDescription(false),
                HttpStatus.BAD_REQUEST,
